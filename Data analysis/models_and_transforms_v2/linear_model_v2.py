...
import sys
import os
from data_transforms_v2 import prep_transform, randomly_flipx, append_distance, randomly_crop
import torch as t
...
data_set = SoberSenseDataset(
    ...
    augmentation_transform= lambda x: randomly_crop(append_distance(x)),
