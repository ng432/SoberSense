...
positive_weight = (len(train_labels) - train_over_threshold_count)/train_over_threshold_count
...
precision, recall, f1, true_labels, predicted_labels = calc_prf1_majority_vote(model, test_dataloader, threshold=0.5, num_rep=1002)
